...
| File | Topics |
|------|--------|
| [references/search.md](search.md) | Search endpoint request/response shape, search types, filters, nested contents, structured output |
| [references/contents.md](contents.md) | Contents endpoint extraction, freshness, statuses, top-level content fields |
| [references/answer.md](answer.md) | Grounded answer generation with citations and structured output |
| [references/agent.md](agent.md) | Agent API for async multi-step research, enrichment, structured output, polling, and events |
| [references/openai-compat.md](openai-compat.md) | OpenAI-compatible endpoints, model routing, `extra_body` usage |
| [references/monitors.md](monitors.md) | Standalone Monitors API for scheduled recurring search |
| [references/migrate-websets-to-agent.md](migrate-websets-to-agent.md) | Migrate Websets to the Agent API: call-site classification, request mapping, delivery rewrite, verification |
| [references/sdks.md](sdks.md) | Python and TypeScript SDK naming, methods, and shape differences |
| [references/http-requests.md](http-requests.md) | Minimal raw HTTP examples across major Exa surfaces |
| [references/models-and-modes.md](models-and-modes.md) | Search type selection, answer/research model routing, latency tradeoffs |
| [references/prompting-and-patterns.md](prompting-and-patterns.md) | Durable query, prompting, freshness, and output-schema patterns |
| [references/common-mistakes.md](common-mistakes.md) | Over-specification and parameter-shape corrections |
